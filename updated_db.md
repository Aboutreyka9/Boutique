...
<!-- 18/10/2025 à 15h12 -->
ALTER TABLE `depense` CHANGE `statut_depense` `statut_depense` ENUM('en attente','approuve','annule','') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'en attente';


removed client_id & fournisseur_id in table versement

UPDATE versement SET pay_mode = 'especes' WHERE pay_mode = 'espece';
