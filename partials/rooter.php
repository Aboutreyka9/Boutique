...
ControllerEntrepot::verifQteArticleTransfert();
ControllerEntrepot::ajouter_panier_transfert();
ControllerEntrepot::ajouter_transfert();
ControllerEntrepot::btn_remove_ajouter_panier_transfert();
...
ControllerEntrepot::changeStatutEntrepotArticle();
ControllerEntrepot::liste_entrepot_article();
ControllerEntrepot::getEntrepotArticleEdit();
ControllerEntrepot::modifier_entrepot_article();
...
ControllerAchat::modifier_achat();
