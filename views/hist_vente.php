...
<table class="table table-striped table-hover my-table">
  ...
  $i = 0;
  $article = Soutra::getHistoriqueSortie();
foreach ($article as $key => $value) {
    ...
    ?>
        <tr>
            ...
            <td class="text-right"><?= number_format($value['prix_vente'],0,","," ") ?></td>
            <td class="text-right"><?= $value['qte'] ?></td>
            <td class="text-right"><?= number_format($value['qte']*$value['prix_vente'],0,","," ") ?></td>
            <td class="text-right"><?= Soutra::date_format($value['d_vente'])?> </td>
