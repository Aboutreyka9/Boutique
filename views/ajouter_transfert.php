...
if (isset($_SESSION['panier_transfert']) && !empty($_SESSION['panier_transfert'])) {

  $data_article = Soutra::getPanierTransfert(implode(',', $_SESSION['panier_transfert']));
}
            ...
            <div class="row my-3">
              <div class="col-md-4">
                <div style="position: relative;" class="form-group">
                  ...
                  <select name="transfert_entrepot" class="form-control transfert_entrepot" id="transfert_entrepot_source">
                    <option value=""></option>
                    <?php
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>Ville</label>
                  <input readonly type="text" id="ville_entrepot_source" class="form-control">
                </div>
              </div>
            </div>
            ...
            <div class="row my-3">
              <div class="col-md-4">
                <div style="position: relative;" class="form-group">
                  ...
                  <select name="transfert_entrepot" class="form-control transfert_entrepot" id="transfert_entrepot_destination">
                    <option value=""></option>
                    <?php
                    $entrepot = Soutra::getAllTable('entrepot', 'etat_entrepot');
                    $output = "";
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>Ville</label>
                  <input readonly type="text" id="ville_entrepot_destination" class="form-control">
                </div>
              </div>
            </div>
        ...
        <tbody class="transfert-table">
          ...
          if (!empty($data_article)) {
            ...
            foreach ($data_article as $row) {
              ...
              $output .= '
                  <td> 
                      <button data-id="' . $row['ID_article'] . '" title="Supprimer l\'article de la liste" class="btn btn-danger btn-sm btn_remove_data_ajouter_panier_transfert">
