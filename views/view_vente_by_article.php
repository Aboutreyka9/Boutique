...
$totaux = Soutra::getTotauxVenteByDateRangeByArticle($start, $end); // méthode adaptée que l'on a créée
?>
<header class="page-title-bar">
  <div class="mb-3" style="display: flex; flex-direction: row; justify-content: space-between; align-items: center;">
    <div class="title">
     ...
     <div class="input-group" style="max-width: 40%;" >
      ...
      <input type="text" name="datefilterVenteByARticle" class="form-control" placeholder="Sélectionner la période">
  ...
  <div class="row mt-5">
    <div class="col-md-6 col-lg-6">
      <div class="card text-center shadow-sm border-primary">
        <div class="card-body">
          <h6 class="text-muted">Quantité vendue</h6>
  ...
  <div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center;">
    ...
    <div class="form-group">
      <a href="<?=URL?>vente" id="clearFilterBtn" class="btn btn-info"><i class="fa fa-eye"></i> Voir par Vente</a>
    </div>
  </div>
</header>
  <!-- .page-section -->
