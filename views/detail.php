...
<div class="card custom-card-detail mb-3">
  <div class="card-body">
    <p class="text-muted mb-1">Administration / Ventes / REF-2026-0005</p>
    ...
    <div class="table-responsive">
      ...
      <table class="table table-hover">
        ...
        <tr class="row' . $row['ID_sortie'] . '">
           ...
           <td>' . $row['mark'] . '</td>
          <td>' . $row['famille'] . '</td>
          <td class="text-right pu">' . number_format($row['prix_vente'], 0, ",", " ") . '</td>
          <td class="text-right qte">' . $row['qte'] . '</td>
          <td class="text-right total">' . number_format($row['prix_vente'] * $row['qte'], 0, ",", " ") . '</td>
           ';
