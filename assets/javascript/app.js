        ...
        if ($(".dashboard_admin").length > 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#montant_vente").text(data.ventes.montant_vente);
                    $("#nombre_reapprovisionnement").text(data.reapprovisionnements.nombre_reapprovisionnement);
                    $("#montant_reapprovisionnement").text(data.reapprovisionnements.montant_reapprovisionnement);
